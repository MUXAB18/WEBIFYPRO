const getBaseTemplate = (title, content, isAdmin = false) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
module.exports = {
  adminNewOrder: (order) => getBaseTemplate('New Order Received! 🚀', `
  ...
  customerOrderConfirmation: (order) => getBaseTemplate('Order Confirmation ✨', `
  ...
  adminNewMessage: (msg) => getBaseTemplate('New Contact Message 📩', `
  ...
  customerMessageConfirmation: (msg) => getBaseTemplate('Message Received 💌', `
